  ...
  <v-card
    ...
    <v-card-actions>
      ...
      <v-btn color="primary" :disabled="!isValid" :loading="submitting" @click="handleSubmit()">
        {{ props.submitLabel || 'ثبت' }}
      </v-btn>

      <v-spacer />

      <v-btn @click="emit('resolve')">
        {{ props.cancelLabel || 'بازگشت' }}
      </v-btn>
...
/* این کامپوننت جهت نمایش دیالوگ های دارای فرم میباشد که امکان دریافت فیلدهای
فرم و همچنین دریافت فانکشن در صورت تایید فرم توسط کاربر میباشد. */